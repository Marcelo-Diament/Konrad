...
rteFormName = "description";
// Height of the rich text editor.
rteHeight = "300px";
// Path to the images folder.
rteImagePath = "javascript/editor/images/";
// Path to insert form popup.
rteHTMLPathInsertForm = "javascript/editor/html/insert_form.html";
// Path to insert checkbox popup.
rteHTMLPathInsertCheckbox = "javascript/editor/html/insert_checkbox.html";
// Path to insert radio button popup.
rteHTMLPathInsertRadiobutton = "javascript/editor/html/insert_radiobutton.html";
// Path to insert text area popup.
rteHTMLPathInsertTextArea = "javascript/editor/html/insert_textarea.html";
// Path to insert submit button popup.
rteHTMLPathInsertSubmit = "javascript/editor/html/insert_submit.html";
// Path to insert image submit button popup.
rteHTMLPathInsertImageSubmit = "javascript/editor/html/insert_image_submit.html";
// Path to reset form button popup.
rteHTMLPathInsertReset = "javascript/editor/html/insert_reset.html";
// Path to insert hidden form field popup.
rteHTMLPathInsertHidden = "javascript/editor/html/insert_hidden.html";
// Path to insert password field popup.
rteHTMLPathInsertPassword = "javascript/editor/html/insert_password.html";
// Path to insert text field popup.
rteHTMLPathInsertText = "javascript/editor/html/insert_text.html";
// Path to insert table popup.
rteHTMLPathInsertTable = "javascript/editor/html/insert_table.html";
// Path to edit table properties popup.
rteHTMLPathEditTable = "javascript/editor/html/edit_table.html";
// Path to insert link popup.
rteHTMLPathInsertLink = "javascript/editor/html/insert_link.html";
// Path to edit link popup.
rteHTMLPathEditLink = "javascript/editor/html/edit_link.html";
// Path to insert image popup.
rteHTMLPathInsertImage = "ext_insertimage.php";
//Módulo da página a verifica as permissoes
rteHTMLModulePage = 0;
