...
Calendar.setup = function (params) {
	...
	param_default("inputCopy",     null);
	param_default("displayArea",   null);
	param_default("button",        null);
	param_default("eventName",     "click");
	param_default("ifFormat",      "y/mm/dd");
	param_default("copyFormat",    "dd/m/y");
	...
	var tmp = ["inputField", "inputCopy", "displayArea", "button"];
	for (var i in tmp) {
	...
	function onSelect(cal) {
		...
		if (cal.params.inputField) {
			...
			if (cal.params.inputCopy) cal.params.inputCopy.value = cal.date.print(cal.params.copyFormat);
		}
