<?php /* Smarty version 2.6.22, created on 2012-05-08 20:46:47
         compiled from mod_workshops.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'mod_workshops.htm', 41, false),array('modifier', 'secureurl', 'mod_workshops.htm', 125, false),array('modifier', 'zerofill', 'mod_workshops.htm', 222, false),array('modifier', 'truncate', 'mod_workshops.htm', 223, false),array('modifier', 'addslashes', 'mod_workshops.htm', 225, false),array('modifier', 'date_format', 'mod_workshops.htm', 380, false),)), $this); ?>
    ...
    <td align="center" valign="top">
		...
		<?php if (! $_GET['option']): ?>
		  <tr>
			...
			<fieldset>
			<legend><img src="images/thumb_mod_cursos.gif" align="middle">&nbsp;Adicionar novo workshop&nbsp;</legend>
			<form action="" method="post" name="add_curso">
			<input type="hidden" name="salvar" value="1">
			  <table width="100%" border="0" cellpadding="1" cellspacing="1" class="form">
				<tr>
				  <td width="100">Nome do workshop:</td>
...
"></td>
			...
			<?php else: ?>
			<fieldset>
			<legend><img src="images/thumb_mod_cursos.gif" align="middle">&nbsp;Editar o workshop&nbsp;</legend>
...
'};" src="images/delete_<?php if ($this->_tpl_vars['cursos'][$this->_sections['i']['index']]['code'] != $_GET['curso_code'] && $this->_tpl_vars['permissions']['usrdelete']): ?>true<?php else: ?>false<?php endif; ?>.gif" style="width:15px; height:16px;" <?php if ($this->_tpl_vars['cursos'][$this->_sections['i']['index']]['code'] == $_GET['curso_code'] || ! $this->_tpl_vars['permissions']['usrdelete']): ?>disabled<?php endif; ?>></td>
                      ...
                      <?php endfor; else: ?>
                      <tr> 
                        <td colspan="4" align="center">Nenhum workshop cadastrado</td>
                      </tr>
                      <?php endif; ?>
                      <tr><td colspan="4">&nbsp;</td></tr>
                    </table>
...
">					
			    ...
			    <tr>
				  ...
				  <td><input name="data" type="text" size="40" maxlength="10" value="<?php echo $_POST['data']; ?>
" id="dt_inicio">					
				</tr>				
				<tr>
				  <td>&nbsp;</td>
...
'};" src="images/delete_<?php if ($this->_tpl_vars['turmas'][$this->_sections['i']['index']]['code'] != $_GET['turma_code'] && $this->_tpl_vars['permissions']['usrdelete']): ?>true<?php else: ?>false<?php endif; ?>.gif" style="width:15px; height:16px;" <?php if ($this->_tpl_vars['turmas'][$this->_sections['i']['index']]['code'] == $_GET['turma_code'] || ! $this->_tpl_vars['permissions']['usrdelete']): ?>disabled<?php endif; ?>></td>
                      ...
                      <?php endfor; else: ?>
                      <tr> 
                        <td colspan="4" align="center">Nenhuma turma cadastrada</td>
                      </tr>
                      <?php endif; ?>
					<tr><td colspan="4">&nbsp;</td></tr>
                    </table>
