<?php /* Smarty version 2.6.22, created on 2012-05-08 10:13:11
         compiled from agenda-de-workshops.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'menuinterno', 'agenda-de-workshops.htm', 1, false),array('modifier', 'nl2br', 'agenda-de-workshops.htm', 15, false),array('modifier', 'escape', 'agenda-de-workshops.htm', 26, false),)), $this); ?>
...
/fazer-reserva-workshop/<?php echo $this->_tpl_vars['getKey'][2]; ?>
...
/" class="informacoes">Solicitar informações</a></li>
 ...
 - <?php echo $this->_tpl_vars['turma']['data']; ?>
</h5>
	<ul>
		...
		<?php if ($this->_tpl_vars['turma']['objetivo']): ?><li><strong>Objetivo do evento:</strong><p><?php echo ((is_array($_tmp=$this->_tpl_vars['turma']['objetivo'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</p></li><?php endif; ?>
		...
		<?php if ($this->_tpl_vars['turma']['instrutor']): ?><li><strong>Palestrante:</strong> <?php echo $this->_tpl_vars['turma']['instrutor']; ?>
</li><?php endif; ?>
...
/agenda-de-workshops/<?php echo $this->_tpl_vars['cursos'][$this->_sections['i']['index']]['url']; ?>
...
/"><?php echo $this->_tpl_vars['cursos'][$this->_sections['i']['index']]['turmas'][$this->_sections['j']['index']]['cidade']; ?>
            ...
            - <?php echo $this->_tpl_vars['cursos'][$this->_sections['i']['index']]['turmas'][$this->_sections['j']['index']]['data']; ?>
</a></td>
        </tr>
...
/media/images/workshop_confirmado.gif" alt=""/></td></tr>
</table>
<?php endif; ?>